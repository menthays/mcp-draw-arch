...
const WorkflowStateSchema = z.object({
  ...
  nodes: z.array(z.object({
    id: z.string(),
    type: z.enum(['actor', 'service', 'database', 'queue', 'cache', 'gateway', 'ui', 'external']),
    label: z.string(),
    metadata: z.record(z.any()).optional()
  })).optional().describe("Structured node definitions"),
  ...
  connections: z.array(z.object({
    from: z.string(),
    to: z.string(),
    type: z.enum(['http', 'async', 'query', 'sync', 'data_flow']),
    label: z.string(),
    metadata: z.record(z.any()).optional()
  })).optional().describe("Structured connection definitions"),
